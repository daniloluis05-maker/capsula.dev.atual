...
@media print{@page{margin:0;size:A4;}body{background:#f8fafc!important;}.page{width:100%;}}`.split('ACCENT').join(ACCENT);
  ...
  _imprimirPDF(`<!DOCTYPE html><html lang="pt-BR" style="color-scheme:light;"><head>
  ...
  <div class="ft"><span class="ft-l">Sistema Gnosis // Psicologia Junguiana // Pearson-Marr // Confidencial</span><span class="ft-r">capsula-dev-atualizado.vercel.app</span></div>
  </div>
